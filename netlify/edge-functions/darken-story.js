export default async (request, context) => {
  ...
  .btn{
    ...
    box-shadow:0 10px 24px rgba(0,0,0,.42), inset 0 1px 0 rgba(255,255,255,.08), inset 0 -1px 0 rgba(0,0,0,.55);
  ...
  .btn::before{
    ...
    inset:0;
    pointer-events:none;
    background:linear-gradient(115deg, rgba(255,255,255,.16), transparent 32%, transparent 68%, rgba(255,138,42,.10));
    opacity:.45;
  }
  .btn:hover,.btn:focus-visible{
    transform:translateY(-2px);
    box-shadow:0 16px 34px rgba(0,0,0,.55), 0 0 28px rgba(255,138,42,.35), inset 0 1px 0 rgba(255,255,255,.12);
  }
  .btn.solid{
    background:linear-gradient(180deg, #b52828, #781313) !important;
    border-color:#c83a2f !important;
    box-shadow:0 13px 28px rgba(0,0,0,.48), 0 0 22px rgba(163,31,31,.22), inset 0 1px 0 rgba(255,255,255,.10), inset 0 -2px 0 rgba(0,0,0,.35);
  }
  ...
  .genre-tag.hot{
    box-shadow:0 10px 22px rgba(0,0,0,.35), 0 0 18px rgba(255,138,42,.08), inset 0 1px 0 rgba(255,255,255,.06);
  }
  ...
  .track.active{
    ...
    box-shadow:inset 4px 0 0 var(--neon), inset 0 1px 0 rgba(255,255,255,.045) !important;
  }

  .icon-btn{
    background:linear-gradient(180deg, rgba(255,255,255,.04), rgba(0,0,0,.28)) !important;
    box-shadow:0 8px 18px rgba(0,0,0,.32), inset 0 1px 0 rgba(255,255,255,.06);
  }
  .icon-btn:hover,.icon-btn:focus-visible{
    transform:translateY(-1px);
    background:linear-gradient(180deg, rgba(255,138,42,.14), rgba(0,0,0,.25)) !important;
    box-shadow:0 12px 24px rgba(0,0,0,.45), 0 0 20px rgba(255,138,42,.16), inset 0 1px 0 rgba(255,255,255,.08);
  }
  ...
  .member:hover{
    ...
    box-shadow:0 24px 48px rgba(0,0,0,.52), 0 0 22px rgba(255,138,42,.08), inset 0 1px 0 rgba(255,255,255,.06);
  }
  .fn-doc{
    border-color:rgba(255,138,42,.20) !important;
    box-shadow:0 18px 34px rgba(0,0,0,.48), inset 0 1px 0 rgba(255,255,255,.04);
  }
  .reel{
    border-color:rgba(255,138,42,.18) !important;
  }
  .reel:hover,.reel:focus-within{
    transform:translateY(-2px);
    box-shadow:0 22px 45px rgba(0,0,0,.55), 0 0 24px rgba(255,138,42,.10), inset 0 1px 0 rgba(255,255,255,.06);
  }

  .player{
    background:linear-gradient(180deg, rgba(22,18,14,.98), rgba(7,6,5,.99)) !important;
    box-shadow:0 -18px 45px rgba(0,0,0,.75), inset 0 1px 0 rgba(255,255,255,.05) !important;
  }

  @media (prefers-reduced-motion: reduce){
    .btn,.member,.reel,.icon-btn{transition:none !important;transform:none !important;}
  }
`;
